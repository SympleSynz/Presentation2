...
- "Trello uses the kanban paradigm for managing projects, originally popularized by Toyota in the 1980s for supply chain management" [1]. This system allowed for higher production levels and maintain the flexibility. It was originally designed to respresent a physical whiteboard with different sections of post-it note ideas, projects, or tasks. The sections consisted of future to-do lists, current doing list, and a completed list. Trello consists of similar attributes it that it has the boards, lists, and cards that represent the same ideas of the orignal physical one. Now Trello is not only web-based, but also has associated apps supported by iPhone, Android and Windows 8/10. The website version of Trello was designed to be accessible in most mobile web browsers, which gives users the ability to use either the app or their mobile web browsers on their phones or tablets. The boards are usually the main project idea that is being implemented. The team members that are invited for access to that board can control the flow of the lists, create cards within it, and collaborate with other members about the project. The lists help seperate the boards into categories. These can consist of project attributes and their stages. The cards represent each element or specific task of the project. They can be customized and can be moved to other lists and boards accordingly. 
